...
game.SpendGold = Object.extend({
   ...
   setBuyText: function(){
       game.data.buytext = new (me.Renderable.extend({
            ...
            draw: function(renderer) {
                ...
                this.font.draw(renderer.getContext(), "Skill 1: Increase Damage. Curent Level: " + game.data.skill1 + " Cost: " + ((game.data.skill1+1)*10), this.pos.x, this.pos.y+40);
   ...
   checkBuyKeys: function(){
      if(me.input.isKeyPresseed("F1")){
          if(this.checkCost(1)){
              this.makePurchase(1);
          }
      }else if(me.input.isKeyPresseed("F2")){
          if(this.checkCost(2)){
              this.makePurchase(2);
          }
      }else if(me.input.isKeyPresseed("F3")){
          if(this.checkCost(3)){
              this.makePurchase(3);
          }
      }else if(me.input.isKeyPresseed("F4")){
          if(this.checkCost(4)){
              this.makePurchase(4);
          }
      }else if(me.input.isKeyPresseed("F5")){
          if(this.checkCost(5)){
              this.makePurchase(5);
          }
      }else if(me.input.isKeyPresseed("F6")){
          if(this.checkCost(6)){
              this.makePurchase(6);
          }
      }
   ...
   checkCost: function(skill){
       if(skill1===1 && (game.data.gold >= ((game.data.skill1+1)*10))){
          return true; 
       }else if(skill1===1 && (game.data.gold >= ((game.data.skill1+1)*10))){
          return true; 
       }else if(skill1===1 && (game.data.gold >= ((game.data.skill1+1)*10))){
          return true; 
       }else if(skill1===1 && (game.data.gold >= ((game.data.skill1+1)*10))){
